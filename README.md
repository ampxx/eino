...
- Context cancellation propagates cleanly through the graph — wrapping your root context with a timeout is an easy way to avoid hung pipelines during development.

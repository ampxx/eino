...
- Context cancellation propagates correctly through the whole graph — wrapping your root context with a timeout (`context.WithTimeout`) is the simplest way to guard against a stalled LLM call hanging forever.

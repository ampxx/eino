...
- Context cancellation propagates correctly through the graph — wrapping your root context with a timeout (`context.WithTimeout`) is an easy way to guard against runaway LLM calls.
